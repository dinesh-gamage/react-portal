...
const Toast = (props) => {
    ...
    return (React.createElement("div", { className: "toast" },
        ...
        React.createElement("div", { className: "toast-content" },
            ...
            React.createElement("div", { className: "content" }, props.content)),
        props.showCloseBtn ?
            React.createElement("div", { className: "close", onClick: handleRemove }, "x")
            : null));
};
Toast.defaultProps = {
    showCloseBtn: true,
...
const ToastProvider = (props) => {
    ...
    return (React.createElement(ToastContext_1.default.Provider, { value: providerValue },
        React.createElement(Portal_1.default, null,
            React.createElement("div", { className: "toast-container" }, toasts.map((toast, key) => renderToast(toast, key)))),
        props.children));
};
